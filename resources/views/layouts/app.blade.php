...
<head>
    ...
    @php $cores = \App\Models\ConfiguracaoCor::global(); @endphp
    <style>
        :root {
            --primary: {{ $cores->primary_color }};
            --primary-light: {{ $cores->primary_color }}dd;
            --secondary: {{ $cores->secondary_color }};
            --accent: {{ $cores->accent_color }};
            --accent-light: {{ $cores->accent_color }}dd;
            --light: {{ $cores->background_color }};
            --dark: #2B2B2B;
            --radius: 12px;
            --radius-sm: 8px;
        ...
        <div class="container">
            <div class="d-flex align-items-center justify-content-between py-3">
                ...
                <nav class="d-none d-md-flex align-items-center gap-1 site-nav">
                    ...
                    <a href="{{ route('pontos-venda') }}" class="nav-link {{ request()->routeIs('pontos-venda') ? 'active' : '' }}">Onde Encontrar</a>
            ...
            <div id="mobileMenu" class="d-md-none pb-3 d-none">
                <nav class="d-flex flex-column gap-1">
                    ...
                    <a href="{{ route('pontos-venda') }}" class="nav-link px-3 py-2 {{ request()->routeIs('pontos-venda') ? 'active' : '' }}">Onde Encontrar</a>
                </nav>
            </div>
        </div>
    </header>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-2">
                    ...
                    <div class="d-flex flex-column gap-2">
                        ...
                        <a href="{{ route('pontos-venda') }}">Onde Encontrar</a>
                    </div>
                </div>
                <div class="col-lg-3">
                    <h6>Contato</h6>
